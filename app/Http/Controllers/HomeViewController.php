...
class HomeViewController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $articles = DB::table('articles')
            ...
            ->select('articles.title', 'articles.thumbnail', 'categories.name as category_name')
        ...
        $bottoms = DB::table('articles')
            ...
            ->select('articles.title', 'articles.thumbnail', 'categories.name as category_name', 'users.name as user_name')
            ->orderBy('articles.created_at', 'desc')
            ->skip(1)
            ->take(3)
            ->get();
